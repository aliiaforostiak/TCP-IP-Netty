...
@Component
public class OrderPricingProcessor implements Processor {

    private final OrderProcessingService orderProcessingService;

    public OrderPricingProcessor(OrderProcessingService orderProcessingService) {
    ...
    public void process(Exchange exchange) {
        ...
        exchange.getMessage().setBody(orderProcessingService.price(context));
    }
}
